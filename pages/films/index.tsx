...
export async function getStaticProps(): Promise<
	GetStaticPropsResult<FilmsPageProps>
> {
	const {
		data: { result },
	} = await axios.get("https://www.swapi.tech/api/films");
...
const FilmsPage: FunctionComponent<FilmsPageProps> = (
	props: FilmsPageProps,
) => {
	...
	const filtered = useMemo(
		() =>
			props.data.filter((film) =>
				film.properties.title.toLowerCase().includes(searchTerm),
			),
